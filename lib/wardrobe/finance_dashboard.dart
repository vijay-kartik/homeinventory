...
import '../finances/account_card.dart'; // Import the account card widget
import '../finances/subscription_card.dart'; // Import the subscription card widget
import '../finances/transaction_table.dart'; // Import the transaction table widget
// import 'monthly_overview_graph.dart'; // Import the graph widget
import '../finances/loan_card.dart';
import '../finances/credit_card_widget.dart';
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 10),
          const TransactionTable(), // Placeholder for transaction table
          const SizedBox(height: 20),
          const Text(
            'Monthly Overview',
            style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
          ...
          const SizedBox(height: 10),
          // const MonthlyOverviewGraph(), // Placeholder for monthly overview graph
          const SizedBox(height: 20),
        ],
      ),
    );
